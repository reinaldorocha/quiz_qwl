export function LoginVisualPanel() {
  return (
    <section className="login-visual-bg relative hidden min-h-screen overflow-hidden md:flex md:w-1/2 md:items-center md:justify-center">
      ...
      <div className="pointer-events-none absolute top-1/2 left-1/2 z-0 size-[180px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-[#3B82F6]/20" />
      ...
      <div className="login-glass-card relative z-10 mx-12 max-w-lg rounded-2xl px-8 py-12">
        ...
        <p className="text-lg leading-relaxed text-white/80">
          Use inteligência artificial para engajar, avaliar e crescer sua
          audiência com fluxos de dados inteligentes.
        </p>

        <div className="mt-8 flex flex-wrap gap-2">
          {["Leads", "Conversão", "Analytics", "IA"].map((tag) => (
            <span
              key={tag}
